...
import projek_pbo.LimasPersegiPanjang;
 ...
 * @author Asus
 */
public class PilihLimasPersegiPanjang extends javax.swing.JPanel {

    private LimasPersegiPanjang LimasPersegiPanjang;

    public PilihLimasPersegiPanjang() {
        initComponents();
        this.LimasPersegiPanjang = new LimasPersegiPanjang(5,10,15);
        tambahkanListener();
        btnHitung.setEnabled(false);
    }

    public void setLimasPersegiPanjang(LimasPersegiPanjang LimasPersegiPanjang) {
        this.LimasPersegiPanjang = LimasPersegiPanjang;
    }
    ...
    private void updatePerhitungan() {
        System.out.println("[DEBUG] Status LimasPersegiPanjang: " + (LimasPersegiPanjang != null ? "Ada" : "Null"));
        try {
            ...
            LimasPersegiPanjang.hitungVolume(panjang,lebar,tinggi);
            LimasPersegiPanjang.hitungLuasPermukaan(panjang,lebar,tinggi);

            double volume = LimasPersegiPanjang.getVolume();
            double luasPermukaan = LimasPersegiPanjang.getLuasPermukaan();
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Ubah Nilai LimasPersegiPanjang");
