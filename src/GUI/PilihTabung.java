 ...
 * @author Asus
 */
public class PilihTabung extends javax.swing.JPanel {

    private Tabung Tabung;

    public PilihTabung() {
        initComponents();
        this.Tabung = new Tabung(7, 10);
        tambahkanListener();
        btnHitung.setEnabled(false);
    }

    public void setTabung(Tabung Tabung
    ) {
        this.Tabung
                = Tabung;
    }
    ...
    private void updatePerhitungan() {
        System.out.println("[DEBUG] Status Tabung: " + (Tabung != null ? "Ada" : "Null"));
        try {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Ubah Nilai Tabung");
