 ...
 * @author Asus
 */
public class PilihKerucut extends javax.swing.JPanel {

    private Kerucut Kerucut;

    public PilihKerucut() {
        initComponents();
        this.Kerucut = new Kerucut(7, 10);
        tambahkanListener();
        btnHitung.setEnabled(false);
    }

    public void setKerucut(Kerucut Kerucut
    ) {
        this.Kerucut
                = Kerucut;
    }
    ...
    private void updatePerhitungan() {
        System.out.println("[DEBUG] Status Kerucut: " + (Kerucut != null ? "Ada" : "Null"));
        try {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Ubah Nilai Kerucut");
